...
## Initial step preparing training and testing dataset
## set working directory to the location where the UCI HAR Dataset was unzipped
setwd('C:/Apps/Janice/R-Portable/workfolder/UCI HAR Dataset')
...
## Step 5. From the dataset in step 4, creates a second, independent tidy data set with the average
##         of each variable for each activity and each subject
